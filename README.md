...
1. Upload the `spotify-2023.csv` file into your Google Colab environment.
2. Open the project notebook (`.ipynb`) in **Google Colab**.
3. Run the cells sequentially to execute the data preparation, clustering, and recommendation steps.
